...
![Librosa](https://img.shields.io/badge/Librosa-blue?style=for-the-badge)
...
- 🎙 **Pre-processing**: Successfully isolated high-fidelity Oud tracks from historical mono-recordings using neural source separation.
- 🎼 **Transcription**: Developing a personalized pitch-tracking system that recognizes neutral notes often "crushed" by standard MIDI systems.
- 🌍 **Community**: Building an open-source corpus of machine-readable Somali microtonal music.

---

## 📫 Let's Collaborate
- **Research Portal**: [qaraamigen-ai.vercel.app](https://qaraamigen-ai.vercel.app/)
- **Organization**: [Qaraami-Al-Research](https://github.com/Qaraami-Al-Research)
- **LinkedIn**: [khalidibrahimabdi1](https://www.linkedin.com/in/khalidibrahimabdi1)
- **Twitter**: [@khalid_ibrahim](https://twitter.com/khalid_ibrahim)
